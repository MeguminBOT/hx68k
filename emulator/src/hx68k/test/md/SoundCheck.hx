...
class SoundCheck {
	...
	public static function run(args:Array<String>):Void {
		...
		machine.load(haxe.io.Path.join([root, "export/md/rom/sound/bin/release/rom.bin"]));

		final elf = new Elf(haxe.io.Path.join([root, "export/md/rom/sound/bin/release/rom.out"]));
