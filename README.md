...
other, and both are being replaced. The m68k toolchain comes with SGDK, so there is nothing else to
install.
...
- [ ] Text, and the unpackers, which wait on the rest of `rescomp.jar`
